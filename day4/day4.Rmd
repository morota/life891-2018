...
**Hypergeometric test**
\begin{align*}
Pvalue &= \sum^{min(S,k)}_{i=g}\frac{{S \choose i} {N-S \choose k-i}  }{{N \choose k} }  \\
&= 1 - \sum^{g-1}_{i=0}\frac{{S \choose i} {N-S \choose k-i}  }{{N \choose k} } 
\end{align*}
...
- inferring the molecular mechanism on the basis ofstatistically significant MeSH or GO annotations alone is  potentially error-prone
